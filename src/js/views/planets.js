                ...
                <div className="card-body">
                    ...
                    <div className="card-text text-black card-body-font-size inside-borders-vehicle px-3 py-2">
                        <dl className="row">
                            ...
                            <dt className="col-sm-4 text-start">Translation:</dt> <dd className="col-sm-8 text-start"> {planet.orbital_period} days</dd>
                        </dl>
                    </div>
                    <div className="d-flex my-1 flex-row justify-content-between align-items-center">
                        <Link to="/details" >
                            <button onClick={() => handleMoreInfoClick(planet.url)}>
                                More info
                            </button>
                        </Link>
